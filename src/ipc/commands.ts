...
export const setBroadcastKeys = (keys: number[]) =>
  invoke<void>("set_broadcast_keys", { keys });
...
export const focusDofusWindow = (hwnd: number) =>
  invoke<void>("focus_dofus_window", { hwnd });
